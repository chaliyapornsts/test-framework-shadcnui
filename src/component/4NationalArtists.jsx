                        ...
                        <div className="flex flex-wrap">
                            {groupedData[firstChar].map(item => (
                                <Link key={item.id} className="p-5 w-1/2 md:w-1/3 lg:w-1/4 cursor-pointer" to={`/profile/${item.id}`}>
                                    <div className="h-0 pb-[100%] relative pulse-effect">
                                        <div className="absolute top-0 bottom-0 left-0 right-0 circle"></div>
...
export default NationalArtists4;
